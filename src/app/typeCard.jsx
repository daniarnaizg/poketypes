...
function TypeCard(props) {
    ...
    return (
        <div
            className={`h-[45px] w-[100px] lg:h-20 lg:w-32 flex relative rounded-md select-none cursor-pointer ${selected ? 'outline outline-2 saturate-150 selected-class' : ''}`}
            style={{
                backgroundImage: `linear-gradient(to right, ${color}, ${darkerColor})`,
                position: 'relative',
                overflow: 'hidden'
            }}
            onClick={onSelect}
